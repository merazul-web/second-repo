...
import { bookFlightCreator, bookingDeletor } from '../../redux/flightBook/actionCreators';
import './AriBook.css';
const AirBook = () => {
    ...
    const handleFormSubmit = (e) => {
        ...
        if (bookingList.length === 3) {
            e.target.reset();
            return alert('You Can not book more than three destination.');
        }
        const form = e.target;
        ...
        const bookingClass = form.ticketClass.value;
        const id = Math.random();
        dispatch(bookFlightCreator({ from, to, date, guests, bookingClass, id }))
        form.reset();
    }
    return (
        <div>
            ...
            <section>
                ...
                <div className="mt-[160px] mx-4 md:mt-[160px] relative">
                    <div className="bg-white rounded-md max-w-6xl w-full mx-auto">
                        <form onSubmit={handleFormSubmit} className="first-hero lws-inputform">
                ...
                <div className="table-container">
                    <table className="booking-table">
                        ...
                        <tbody className="divide-y divide-gray-300/20" id="lws-previewBooked">
                            ...
                            {
                                bookingList.length > 0 && bookingList.map((booking, index) => <tr key={index} className="lws-bookedTable text-black">
                                    ...
                                    <td className="px-6 py-4 text-center">
                                        <span className="lws-bookedClass"> {booking.bookingClass} </span>
                                    </td>
                                    <td className="px-6 py-4 text-center">
                                        <div className="flex justify-center gap-4">
                                            <button className="lws-remove" onClick={() => dispatch
                                                (bookingDeletor(booking.id))}>
